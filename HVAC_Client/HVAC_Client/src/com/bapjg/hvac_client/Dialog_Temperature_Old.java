...
public class Dialog_Temperature_Old 								extends 		DialogFragment 
{
...
//	public Interface_Response		callBack;
	...
	public Dialog_Temperature_Old() 
    {
    }
	public Dialog_Temperature_Old(TextView	writeBack, Integer	tempMin, Integer  step, Integer  steps) 
    {
		super();
