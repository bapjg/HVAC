...
//--------------------------------------------------------------|---------------------------|--------------------------------------------------------------------
public class Panel_3_Calendars_Circuits_Adapter_WORK 			extends 					Panel_0_Adapter
{
 
    public Panel_3_Calendars_Circuits_Adapter_WORK(Context context, int resource, ArrayList listData) 
    {
...
//    	RowHolder 												row							= new RowHolder();
    	...
    	Element_Slots_WeekDays										weekDays					= new Element_Slots_WeekDays();
    	Element_Slots_DayTimes										daySlots 					= new Element_Slots_DayTimes();

    	adapterElement.insertPoint.addView(weekDays);
    	adapterElement.insertPoint.addView(daySlots);
    	
    	weekDays.setData(listItem.days, Global.eRegCalendars.fetchDays(listItem.days)); // TODO Convert 2nd param to numberlist
    	daySlots.setData(listItem);
