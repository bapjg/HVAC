...
static uint32_t speed 		= 100000;							//Was 100000. Brought down to 50 000, which no longer worked from oct 2016.
...
//printout(buf);
			...
			usleep(10000);										// It seems that going too fast can create bad results so wait 10 000 microseconds (10 ms)
		}
