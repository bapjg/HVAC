...
public class LogIt
{
    ...
    {
		if (!Global.httpSemaphore.semaphoreLock("LogIt.tempData_OLD"))
		{
			System.out.println(dateTimeStamp() + " LogIt.tempData_OLD Lock timedout, owned by " + Global.httpSemaphore.owner);
			return;
		}
